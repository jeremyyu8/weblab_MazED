  ...
  return (
    <>
      <div className="">
        ...
        >
          <div className="p-4">
            ...
            >
              <FontAwesomeIcon icon={faAnglesLeft} size="md" />
            </button>
      ...
      <button
        ...
        className="fixed top-[80px] rounded-full z-10 p-2 text-blue-800 border-none text-2xl font-bold hover:cursor-pointer scale-75 hover:bg-blue-400"
        onClick={() => props.setIsOpen(!props.isOpen)}
      >
